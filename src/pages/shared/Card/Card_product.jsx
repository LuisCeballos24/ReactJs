...
const ProductCard = (props) => {
  ...
  return (
    <div className="flex overflow-hidden flex-col justify-center py-5 rounded-md shadow-lg md:flex-row card">
      <div className="flex justify-center items-center h-full bg-red-500 rounded-full sm:h-96 lg:h-full"></div>

      <div className="w-full md:w-1/2">
        <button
          onClick={() => Vista()}
          className="py-2 w-full text-white bg-red-500 rounded rounded-lg md:mt-0 md:ml-4"
        >
        ...
        <div className="relative">
          <div className="card-image">
            <img
              ...
              className="w-full h-auto lg:w-700"
            />
